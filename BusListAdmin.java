...
public class BusListAdmin extends javax.swing.JFrame {
    ...
    public void jTable1()
    {
        try
        {
            pstmt= conn.prepareStatement("select BUSID, DRIVERNAME, MOBILENUMBER, SOURCE, DESTINATION from BUSLIST");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "BUS ID", "DRIVER NAME", "MOBILE NUMBER", "FROM", "TO"
            }
        ));
