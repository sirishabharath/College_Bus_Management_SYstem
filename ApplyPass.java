...
public class ApplyPass extends javax.swing.JFrame {
    ...
    public ApplyPass() throws SQLException {
        initComponents();
        imageSize();
        pstmt= conn.prepareStatement("select BUSID from BUSLIST");
        rs= pstmt.executeQuery();
        while(rs.next())
        {
                String bi=rs.getString("busid");
                busids.add(bi);
        }        
        role.setModel(new SpinnerListModel(busids));
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 5, true), "APPLY PASS", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Times New Roman", 1, 20), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        role.setModel(new javax.swing.SpinnerListModel(new String[] {""}));
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        try
        {
            pstmt=conn.prepareStatement("insert into ADMIN (ID, PASSWORD) values (?,?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApplyPass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ApplyPass().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(ApplyPass.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
